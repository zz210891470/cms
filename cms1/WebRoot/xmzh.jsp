...
<body>
    ...
    <div class="mainbody" align="center" style="height:auto;">
    	<div class="infolist_left" style="height:auto;min-height:500px;_height:500px;">
        	<div class="infolist_left_top" style="background-image:url(images/info_xmzh.jpg);"></div>
        ...
        <div class="infolist_right">
       	<div class="address"><span>当前位置：<a href="#" target="_self">网站首页</a> > 项目转化</span></div>
        <div id="main" style="height:auto; padding-top:20px;">${item }</div>
        </div>
