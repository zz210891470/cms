...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <input id="status" value="${status }" type="hidden"/>
	<form name="form" method="post" action="<%=basePath%>admin/zsxm/ZsxmServlet?action=sadd" id="form">
    	<div class="navigation"><a href="<%=basePath%>admin/zsxm/ZsxmServlet?action=toImport" target="_self" class="goto">批量导入项目</a>首页 &gt; 招商项目管理 &gt; 项目信息录入</div>
    	<div class="tab_con" style="display:block;">
    		<table class="form_table">
				...
				<tr>
					<th>总投资(万元)：</th>
					<td><input name="ztz" type="text" value="" maxlength="100" onblur="validNum(this)" class="txtInput normal required" /></td>
				</tr>
				<tr>
					<th>建设规模及内容：</th>
