...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="mainbody">
	<form name="form" method="post" action="<%=basePath%>admin/zdxm_sbyh/ZdxmSbyhServlet?action=update" id="form">
    		...
    		<table width="100%" border="1" cellpadding="0" cellspacing="0" style="border:solid 1px #EDECFF;" >
				        ...
				        <td width="130">
							...
							<select name="kgy" id="kgy" class="select2">
								<%
									...
									for(int i=1; i<13; i++){
										if(i==FavoritesHelper.stringToint(item.getKgy())){
											%>
				...
				<tr>
				  ...
				  <tr>
				    ...
				    <td colspan="4"><input name="ztz" type="text" value="${item.ztz }" onkeyup="clearNoNum(this)" maxlength="100"  class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				    ...
				    <td height="28" colspan="3" style="width:470px;"><input name="wctz" type="text" value="${item.wctz} " maxlength="100" onkeyup="clearNoNum(this)"   class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
				    ...
				    <td height="28" colspan="3"><input name="jhtz" type="text" value="${item.jhtz }" maxlength="100"  onkeyup="clearNoNum(this)"   class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				    ...
				    <table border="0" cellspacing="0" cellpadding="0" style="display:;">
				      ...
				      <tr>
				        <td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz1" type="text" value="${item.tz1 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
				        <td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz2" type="text" value="${item.tz2 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz3" type="text" value="${item.tz3 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz4" type="text" value="${item.tz4 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz5" type="text" value="${item.tz5 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz6" type="text" value="${item.tz6 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz7" type="text" value="${item.tz7 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz8" type="text" value="${item.tz8 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz9" type="text" value="${item.tz9 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz10" type="text" value="${item.tz10 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
						<td height="25" align="center" bgcolor="White" style="border-right:solid 1px #d5d5d5;">
							<input name="tz11" type="text" value="${item.tz11 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
				        <td align="center" bgcolor="White">
							<input name="tz12" type="text" value="${item.tz12 }" maxlength="100"  class="txtInput normal required" onkeyup="clearNoNum(this)"  style="width:100%;border:0;" />
						</td>
				      </tr>
				    </table></td>
				  </tr>
				  ...
				  <tr>
				    ...
				    <td height="35" colspan="3"><input name="zjppzc" id="zjppzc" type="text" value="${item.zjppzc }" maxlength="100" onkeyup="clearNoNum(this)"   class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				    <td height="35" align="center">银行贷款(万元)</td>
				    <td height="35" colspan="3"><input name="zjppdk" id="zjppdk" type="text" value="${item.zjppdk }" maxlength="100" onkeyup="clearNoNum(this)"   class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				    <td height="35" align="center">政府投资(万元)</td>
				    <td height="35" colspan="3"><input name="zjppzf" id="zjppzf" type="text" value="${item.zjppzf }" maxlength="100" onkeyup="clearNoNum(this)"   class="txtInput normal required" /></td>
				  </tr>
				  <tr>
				  ...
				  <tr>
				    ...
				    <td height="35" colspan="3">
				    	<select name="kgyf" id="kgyf" class="select2">
								<%
									for(int i=1; i<13; i++){
										if(i==FavoritesHelper.stringToint(item.getKgyf())){
											%>
												<option value="<%=i %>" selected><%=i %></option>
											<%
										}else{
