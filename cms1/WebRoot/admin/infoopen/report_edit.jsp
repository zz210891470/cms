...
<body class="mainbody">
<form name="form1" method="post" action="<%=basePath%>admin/infoopen/InfoReportServlet?act=update" id="form1" onsubmit="return checkform();">
	<div class="navigation">首页 &gt; 政府信息公开专栏 &gt; 信息公开年度报告 &gt; 编辑信息</div>
