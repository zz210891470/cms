...
<title>栏目管理</title>
  ...
  <body class="mainbody">
   ...
   <div class="navigation"><a href="javascript:window.parent.hideFrame();" class="back">后退</a>首页 &gt; 文章管理 &gt; 添加信息</div>
<div id="contentTab">
    <ul class="tab_nav">
        ...
        <table class="form_table">
            ...
            <tr>
                ...
                <td>
					...
					<input id="istop" type="checkbox" value="1" name="istop" /><label for="istop">置顶</label>
                </td>
            </tr>
            <tr>
                <th>文章作者：</th>
