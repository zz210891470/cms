...
<head>
    ...
    function saveandrelease(){
           if($("#bt").val() != "" && $("#rq").val() ){
               ...
               document.all.articleForm.action="<%=basePath%>admin/article/SubArticleServlet?act=updateandrelease";
       ...
       function savecaogao(){
           if($("#bt").val() != "" && $("#rq").val() ){
                      document.all.articleForm.target="_self";
               document.all.articleForm.action="<%=basePath%>admin/article/SubArticleServlet?act=updatecaogao";
               document.all.articleForm.submit();
           }else{
               alert("标题和日期必须填写！");
           }
       ...
       function save(){
           ...
           if($("#bt").val() != "" && $("#rq").val() ){
                      document.all.articleForm.target="_self";
                               document.all.articleForm.action="<%=basePath%>admin/article/SubArticleServlet?act=update";
  ...
  <body class="mainbody">
      <form name="articleForm" method="post" action="<%=basePath%>admin/article/SubArticleServlet?act=update" id="form1">
