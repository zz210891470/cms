...
<title>修改下载</title>
  ...
  <body class="mainbody">
      <form name="articleForm" method="post" action="<%=basePath%>admin/article/ArticleServlet?act=updateload" id="form1" >
   
   <div class="navigation"><a href="javascript:back();" class="back">后退</a>首页 &gt; 下载管理 &gt; 添加信息</div>
   <div id="contentTab">
    <ul class="tab_nav">
    ...
    <input type="hidden" name="pid" value="${pid}"/>
        <table class="form_table">
            ...
            <tr>
                ...
                <td><input name="bt" type="text" value="${item.bt }" maxlength="100" id="bt" class="txtInput normal required" /><span style="color:red;">*</span></td>
            </tr>
            ...
            <tr>
                <th>文件说明：</th>
                <td>
                <textarea name="nr" rows="2" cols="20" id="nr" class="small">${item.nr }</textarea>
                </td>
            </tr>
            <tr>
                <th valign="top" style="padding-top:10px;">附件上传：</th>
                <td>

                    <input name="ljwz" type="hidden"  id="ljwz" value="${item.ljwz }" />
                    <input name="zz" type="hidden"  id="filesize" />
                    <input type="file" id="file" name="file" /> 
                    <img src="../images/loading.gif" id="loading" style="display: none;"/>
                    <div class="upload_btn" onclick="ajaxFileUpload()"><span id="upload">上传&nbsp;</span></div>
                    <span id="flag"><a href="javascript:download();">${item.ljwz }</a></span><br/>
                    <span style="color:red">&nbsp;*请上传doc,xls,ppt等文档类文件，其他格式文件请压缩为zip类型压缩包上传</span>
                </td>
            </tr>
