...
<title>栏目管理</title>
    ...
    <script type="text/javascript">
       ...
       function save(){
           ...
           if($("#bt").val() != "" && $("#rq").val() ){
                      document.all.articleForm.target="_self";
                       document.all.articleForm.action="<%=basePath%>admin/article/ArticleServlet?act=updatecontent";
       ...
       function saveandrelease(){
           ...
           if($("#bt").val() != "" && $("#rq").val() ){
                      document.all.articleForm.target="_self";
               document.all.articleForm.action="<%=basePath%>admin/article/ArticleServlet?act=updateandreleasecontent";
               document.all.articleForm.submit();
