    ...
    <script type="text/javascript">
      ...
      function save(){
           ...
           if($("#bt").val() != "" && $("#rq").val() ){
               ...
               document.all.articleForm.action="<%=basePath%>admin/article/SubArticleServlet?act=addcontent";
         ...
         function saveandrelease(){
           ...
           if($("#bt").val() != "" && $("#rq").val() ){
                document.all.articleForm.target="_self";
               document.all.articleForm.action="<%=basePath%>admin/article/SubArticleServlet?act=saveandreleasecontent";
               document.all.articleForm.submit();
...
<div id="contentTab">
    ...
    <input type="hidden" name="pid" value="${pid}"/>
        <table class="form_table">
            ...
            <tr>
                <th>文章摘要：</th>
                <td><textarea name="zy" rows="2" cols="20" id="txtZhaiyao" class="small"></textarea></td>
            </tr>
