	...
	<div position="top" class="header">
		<div class="header_box">
			<div class="header_right">
				...
				<a href="javascript:f_addTab('password','密码修改','password_sbyh.html')">密码修改</a> | 
	...
	<!--左边-->
        <div position="left"  title="管理菜单" id="accordion1"> 
			...
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			  	  <li><a class="l-link" href="javascript:f_addTab('zdxm_ll','重点项目添加','zdxm_sbyh/ZdxmSbyhServlet?action=sbxmlr')">重点项目添加</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_gl','重点项目信息列表','zdxm_sbyh/ZdxmSbyhServlet?action=xmgllist')">重点项目信息列表</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_yb','重点项目建设月报','zdxm_sbyh/ybgl.html')">重点项目建设月报</a></li>
				  </ul>
			</div>
			
			
			<div title="重大项目管理" iconcss="menu-icon-order" id="tab9">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('zdaxm_ll','项目信息录入','zdaxm_sbyh/ZdaxmSbyhServlet?action=sbxmlr')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_gl','项目信息管理','zdaxm_sbyh/ZdaxmSbyhServlet?action=xmgllist')">项目信息管理</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_yb','项目月报管理','zdaxm_sbyh/ybgl.html')">项目月报管理</a></li>
				  </ul>
			</div>
			
		
			<div title="储备项目管理" iconcss="menu-icon-order" id="tab9">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('zdaxm_ll','项目信息录入','cbxm_sbyh/CbxmSbyhServlet?action=sideradd')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_gl','项目信息管理','cbxm_sbyh/CbxmSbyhServlet?action=list')">项目信息管理</a></li>
				  </ul>
			</div> 
