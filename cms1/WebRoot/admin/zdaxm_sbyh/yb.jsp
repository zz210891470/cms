...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script>
	    ...
	    //--------
	    function read(id){
	        $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=toYbRead&id="+id);
	    ...
	    //--------
	    function edit(id){
	        $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=toYbEdit&id="+id);
	        $("#frameDiv").removeClass("hideDiv");
	        $("#frameDiv").addClass("showDiv");
	    }
	    //--------
	    ...
	    function saveup(id){
	        if(confirm("确定要上报数据？")){
	        	theFrame.location.href='<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=saveup&id='+id;
	        }
	    }
        ...
        //添加列表项
        function add(id){
            $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=yblr&id="+id);
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
  	...
  	<form name="form" method="post" action="" id="form">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
			<tr>
			  ...
			  <th width="80" align="center">填报日期</th>
