...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
	    //浏览项目
	    function read(id){
	        $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=toRead&id="+id);
	        $("#frameDiv").removeClass("hideDiv");
	        $("#frameDiv").addClass("showDiv");
	    }
        function upmsg(i){
        	if(confirm("项目信息上报后将不能编辑或删除，确定要上报项目信息？")){
	            document.all.pageform.action='<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=upmsg&id='+i;     
        ...
        //--------
        function edit(i){
            $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=toEdit&id="+i);
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
        ...
        //添加列表项
        function add(){
            $("#theFrame").attr("src","<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=toAdd");
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
        //上报项目
        ...
        function hideAddFrame(){
             document.location.href='<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=xmgllist';
        }
        ...
        function del(i){
            ...
            document.all.pageform.action='<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=del'; 
            document.all.pageform.submit(); 
        }
        ...
        function goPage(i){
        	$("#pageNo").val(i);
      	    document.all.pageform.action='<%=basePath%>admin/zdaxm_sbyh/ZdaxmSbyhServlet?action=xmgllist';
		    document.all.pageform.submit();    
        }
  ...
  <body class="mainbody">
  	<form name="pageform" method="post" action="" id="form">
    	<div class="navigation">首页 &gt; 重点项目管理 &gt; 项目信息管理</div>
    	<div class="tools_box">
		    <div class="tools_bar">
	            <div class="search_box">
				    <input name="searchStr" type="text" id="searchStr" class="txtInput" value="${searchStr }"/>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
			<tr>
			  <th width="40">选择</th>
			  <th width="60" align="center">项目年度</th>
			  <th align="center">项目名称</th>
			  <th width="60" align="center">总投资</th>
			  <th width="60" align="center">计划投资</th>
			  <th width="100" align="center">所属区域</th>
			  <th width="80" align="center">建设年限</th>
      ...
      <div id="frameDiv" class="hideFrame" >
          <iframe  src="" width="100%" height="1200px" scrolling="auto" frameborder="0" name="theFrame" id="theFrame"></iframe>
      </div>
    </form>
    </body>
</html>