...
<div class="navigation">首页 &gt; 系统设置管理 &gt; 系统角色管理</div>
    <form name="pageform"  method="post">
    <div class="tools_box">
	    <div class="tools_bar">
	        <a href="javascript:add();" class="tools_btn"><span><b class="add">添加角色</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
     ...
     <tr>
        ...
        <td align="center"><a href="SysRoleServlet?act=updatepage&id=${item.id}">修改</a></td>
      </tr>
     </c:forEach> 
	 </table>
 </form>
