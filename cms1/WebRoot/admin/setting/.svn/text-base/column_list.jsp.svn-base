...
<head>
	...
	<script type="text/javascript">
      function add(){
        $.ligerDialog.open({ url: '<%=basePath%>admin/setting/SysColumnServlet?act=addpage',title: '添加栏目', width:500, height: 300, modal:false, isResize:true });
      }
      function gopage(i){
      ...
      function edit(id){
      	$.ligerDialog.open({ url: 'SysColumnServlet?act=updatepage&id='+id,title: '编辑栏目', width:500, height: 300, modal:false, isResize:true });  
      }
      function del(id){
...
<div class="navigation">首页 &gt; 系统设置管理 &gt; 系统栏目管理</div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
     ...
     <tr>
        ...
        <td align="center">
        	<a href="SysColumnServlet?act=toSubColumn&pid=${column.id}" target="_self">子栏目管理</a>&nbsp;
