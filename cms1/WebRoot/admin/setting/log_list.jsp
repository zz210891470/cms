...
<div class="navigation">首页 &gt; 系统设置管理 &gt; 系统日志管理</div>
<form name="pageform"  method="post">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th align="left">备注</th>
        <th width="15%" align="left">登录IP</th>
        <th width="18%" align="left">登录时间</th>
      </tr>
     ...
     <tr>
      ...
      function gopage(i){
	    var pagesize=$('#txtPageNum').val();      
      	document.location.href='<%=basePath%>admin/setting/SysLogServlet?act=list&pageNo='+i+'&pageSize='+pagesize;
		return false;
      }
