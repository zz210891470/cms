	...
	<!--左边-->
        <div position="left"  title="管理菜单" id="accordion1"> 
			...
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			      <li><a class="l-link" href="javascript:f_addTab('zsxm_ll','项目信息录入','zsxm/ZsxmServlet?action=add')">项目信息录入</a></li>
			...
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('cbxm_ll','项目信息录入','cbxm/CbxmServlet?action=add')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_sh','项目信息审核','cbxm/CbxmServlet?action=audit')">信息信息审核</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_gl','项目信息管理','cbxm/CbxmServlet?action=list')">信息信息管理</a></li>
