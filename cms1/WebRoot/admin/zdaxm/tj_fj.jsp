...
<script>
    ...
    $(function(){
        $.post("ZdaxmServlet?action=getXxfjhzInfo&year=${year}&fromMonth=${fromMonth}&toMonth=${toMonth}",function(data){
	...
	<tr style="height:50px;">
		<td align="right">
			<form name="frm" id="frm" method="post" action="<%=basePath%>admin/AjaxServlet?act=gbxls" target="_blank" style=" margin:0px; padding:0px;">
                <input type="hidden" id="title" name="title" value="重大项目分级汇总"/>
...
<TABLE border="1" cellSpacing="0" cellPadding="0" width="750" align="center"  id="tdata">
    ...
    <TR bgColor="#eaeaea">
      <TD height="40" width="250" align="middle">地区名称</TD>
      <TD width="150" align="center">项目数</TD>
      <TD width="150" align="center">总投资(万元)</TD>
      <td width="150" align="center">年度计划投资(万元)</td>
