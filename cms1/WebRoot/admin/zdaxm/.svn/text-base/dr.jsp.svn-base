...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    $.ajaxFileUpload({  
                url:'<%=basePath%>action/xlsupload.do?lb=zdaxm&ajaxfilename='+escape(escape(filename)),//用于文件上传的服务器端请求地址  
	...
	function  back(){
	    ...
	    document.location.href="ZdaxmServlet?action=sideradd";
	}
	
	
	function download(){
     var filename="重大项目导入模板.xls";
  ...
  <body class="mainbody">
    <div class="navigation">首页 &gt; 重大项目管理 &gt; 批量导入项目</div>
