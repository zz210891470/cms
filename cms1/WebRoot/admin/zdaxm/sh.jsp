...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        ...
        //添加列表项
        function audit(i){
            $("#theFrame").attr("src","<%=basePath%>admin/zdaxm/ZdaxmServlet?action=toAudit&id="+i);
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
        ...
        function search(){
            ...
            document.all.pageform.action='<%=basePath%>admin/zdaxm/ZdaxmServlet?action=audit';
		    document.all.pageform.submit();  
        }
    </script>
			...
			<c:forEach items="${pager.resultList}" var="item">
		     <tr>
		        ...
		        <td align="center">
		          ...
		          <a href="javascript:audit(${item.id })" >审核</a>
                </td>
		      </tr>
		    </c:forEach>  
		</table>
