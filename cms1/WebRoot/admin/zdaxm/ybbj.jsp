...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
       ...
       function dywcjs(){
	   		...
	   		if(dywc!=""){
	   			document.getElementById("span_dnwc").innerHTML=parseFloat(dywc)+parseFloat(document.getElementById("dnwc2").value)-parseFloat(dywc2);
	   			document.getElementById("dnwc").value=parseFloat(dywc)+parseFloat(document.getElementById("dnwc2").value)-parseFloat(dywc2);
	   			if(${yf}!=1){
  ...
  <body class="mainbody">
  	<form name="form" method="post" action="ZdaxmYbServlet?action=edityb" id="form">
  ...
  <table border="1" width="100%"  align="center" cellspacing="0">
    ...
    <tr>
      ...
      <c:if test="${yf>1}">
	      <td align="center">
	      	<span id="span_kgwc">${zdaxmyb.kgljwc}</span>
	      	<input name="kgwc" type="hidden" value="${zdaxmyb.kgljwc}" id="kgwc" />
	      	<input name="kgwc2" type="hidden" value="${zdaxmyb.kgljwc}" id="kgwc2" />
	      </td>
      </c:if>
      <c:if test="${yf==1}">
     	 <td align="center">
	      	<input name="kgwc" type="text" value="${zdaxmyb.kgljwc}" id="kgwc" onkeyup="clearNoNum(this);"/>
	      </td>
      </c:if>
    </tr>
    <tr>
