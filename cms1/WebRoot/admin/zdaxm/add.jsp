...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>admin/images/style.css" />
...
<body class="mainbody">
	...
	<form name="form" method="post"
		action="<%=basePath%>admin/zdaxm/ZdaxmServlet?action=sadd" id="form">
    	<div class="navigation"><a href="<%=basePath%>admin/zdaxm/ZdaxmServlet?action=toImport" target="_self" class="goto">批量导入项目</a>首页 &gt; 重大项目管理 &gt; 项目信息录入</div>
		<div class="tab_con" style="display:block;">
			<table class="form_table">
				<col width="150px"></col>
				<tbody>
					<tr>
						<th height="35" align="center">项目年度：</th>
