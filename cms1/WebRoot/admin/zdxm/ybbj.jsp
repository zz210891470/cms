...
<html xmlns="http://www.w3.org/1999/xhtml">
       ...
       function back(){
    	...
    	function dwzjjs(){
    		...
    		if(dwzj1!=""){
    			...
    			document.getElementById("span_kgdwzj").innerHTML=parseFloat(dwzj1)+parseFloat(document.getElementById("kgdwzj1").value);
    	        document.getElementById("span_hjkgdw").innerHTML=parseFloat(dwzj1)+parseFloat(document.getElementById("kgdwzj1").value)
    	        +parseFloat(dwzj2)+parseFloat(document.getElementById("kgdwzj2").value)+parseFloat(dwzj3)+parseFloat(document.getElementById("kgdwzj3").value);
    		}
    		if(dwzj2!=""){
    			document.getElementById("span_dndwzj1").innerHTML=parseFloat(dwzj2)+parseFloat(document.getElementById("dndwzj2").value);
    			document.getElementById("span_kgdwzj1").innerHTML=parseFloat(dwzj2)+parseFloat(document.getElementById("kgdwzj2").value);

    		}
    		if(dwzj3!=""){
    			document.getElementById("span_dndwzj2").innerHTML=parseFloat(dwzj3)+parseFloat(document.getElementById("dndwzj3").value);
    			document.getElementById("span_gkdwzj2").innerHTML=parseFloat(dwzj3)+parseFloat(document.getElementById("kgdwzj3").value);
  ...
  <body class="mainbody">
  	<form name="form" method="post" action="<%=basePath%>admin/zdxm/ZdxmYbServlet?action=edityb" id="form">
  ...
  <table border="1" width="100%"  align="center" cellspacing="0">
    ...
    <tr>
      ...
      <td width="15%" align="center">
          <input name="dwzj1" type="text" value="${zdxmyb.dwzj1}" id="dwzj1" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);dwzjjs();" />
      </td>
      <td width="15%" align="center" id="td_dndwzj1">
      		<span id="span_dndwzj">${zdxmyb.dnljdw1}</span>
      		<script>document.getElementById("span_dndwzj").innerHTML=parseFloat(${zdxmyb.dwzj1})+parseFloat(${zdxmyb.dnljdw1});</script>
      		<input name="dndwzj1" type="hidden" value="${zdxmyb.dnljdw1}" id="dndwzj1" /></td>
      <td width="15%" align="center">
      	<c:if test="${yf==1}">
      		<input name="kgdwzj1" type="text" value="${zdxmyb.kgljdw1}" id="kgdwzj1" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);kgdwzjjs();" />
      	</c:if>
      	<c:if test="${yf>1}">
      		
      		<span id="span_kgdwzj">${zdxmyb.kgljdw1}</span>
      		<input name="kgdwzj1" type="hidden" value="${zdxmyb.kgljdw1}" id="kgdwzj1" />
      		<script>document.getElementById("kgdwzj1").value=parseFloat(${zdxmyb.kgljdw1})-parseFloat(${zdxmyb.dwzj1});</script>
    ...
    <tr>
      ...
      <td width="15%" align="center">&nbsp;</td>
      <td width="15%" align="center">
          <input name="dwzj2" type="text" value="${zdxmyb.dwzj2}" id="dwzj2" style="width:80px;" class="txtInput normal required"  onchange="clearNoNum(this);dwzjjs();"/>
      </td>
      <td width="15%" align="center">
      <span id="span_dndwzj1">${zdxmyb.dnljdw2}</span>
      	<script>document.getElementById("span_dndwzj1").innerHTML=parseFloat(${zdxmyb.dwzj2})+parseFloat(${zdxmyb.dnljdw2});</script>
      	<input name="dndwzj2" type="hidden" value="${zdxmyb.dnljdw2}" id="dndwzj2" />
      </td>
      <td width="15%" align="center">
      	<c:if test="${yf==1}">
      		<input name="kgdwzj2" type="text" value="${zdxmyb.kgljdw2}" id="kgdwzj2" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);kgdwzjjs();" />
      	</c:if>
      	<c:if test="${yf>1}">
      		<span id="span_kgdwzj1">${zdxmyb.kgljdw2}</span>
      		<input name="kgdwzj2" type="hidden" value="${zdxmyb.kgljdw2}" id="kgdwzj2" />
      			<script>document.getElementById("kgdwzj2").value=parseFloat(${zdxmyb.kgljdw2})-parseFloat(${zdxmyb.dwzj2});</script>
      	</c:if>
      </td>
    </tr>
     <tr>
      ...
      <td width="15%" align="center">&nbsp;</td>
      <td width="15%" align="center">
          <input name="dwzj3" type="text" value="${zdxmyb.dwzj3}" id="dwzj3" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);dwzjjs();" />
       </td>
      <td width="15%" align="center">
      	<span id="span_dndwzj2">${zdxmyb.dnljdw3}</span>
      	<script>document.getElementById("span_dndwzj2").innerHTML=parseFloat(${zdxmyb.dwzj3})+parseFloat(${zdxmyb.dnljdw3});</script>
      	<input name="dndwzj3" type="hidden" value="${zdxmyb.dnljdw3}" id="dndwzj3" />
      </td>
      <td width="15%" align="center">
      	<c:if test="${yf==1}">
        	<input name="kgdwzj3" type="text" value="${zdxmyb.kgljdw3}" id="kgdwzj3" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);kgdwzjjs();" />
        </c:if>
        <c:if test="${yf>1}">
        	<span id="span_gkdwzj2">${zdxmyb.kgljdw3}</span>
        	<input name="kgdwzj3" type="hidden" value="${zdxmyb.kgljdw3}" id="kgdwzj3" />
      		<script>document.getElementById("kgdwzj3").value=parseFloat(${zdxmyb.kgljdw3})-parseFloat(${zdxmyb.dwzj3});</script>
       	</c:if>
       </td>
    </tr>
    ...
    <tr>
      ...
      <td width="15%" align="center">
      	<span id="span_hjdydw">${zdxmyb.dwzjhj }</span>
        <input name="hjdydw" type="hidden" value="${zdxmyb.dwzjhj}" id="hjdydw" />
      </td>
      <td width="15%" align="center">
      <span id="span_hjdndw">${zdxmyb.dnljdwhj}</span>
      	<script>document.getElementById("span_hjdndw").innerHTML=parseFloat(${zdxmyb.dwzjhj})+parseFloat(${zdxmyb.dnljdwhj});</script>
      ...
      <input name="hjkgdw" type="hidden" value="${zdxmyb.kgljdwhj}" id="hjkgdw" />
      	<script>document.getElementById("hjkgdw").value=parseFloat(${zdxmyb.kgljdwhj})-parseFloat(${zdxmyb.dwzjhj});</script>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="40%" colspan="2" align="center"><input name="dywc" type="text" value="${zdxmyb.bywc}" id="dywc" style="width:80px;" class="txtInput normal required" onchange="clearNoNum(this);dywcjs();" /></td>
      <td width="30%" colspan="2" align="center">
      	<span id="span_dnwc"></span>
      	<script>document.getElementById("span_dnwc").innerHTML=parseFloat(${zdxmyb.bywc})+parseFloat(${zdxmyb.nczbywc});</script>
      	
        <input name="dnwc" type="hidden" value="${zdxmyb.nczbywc}" id="dnwc" />
      </td>
      <td width="30%" colspan="2" align="center">
      <span id="span_kgwc">${zdxmyb.kgljwc}</span>
      	<script>document.getElementById("span_kgwc").innerHTML=parseFloat(${zdxmyb.bywc})+parseFloat(${zdxmyb.kgljwc});</script>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="xxjd" rows="2" cols="20" id="xxjd" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.xxjd}</textarea>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="scnl" rows="2" cols="20" id="scnl" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.scnl}</textarea>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="czwt" rows="2" cols="20" id="czwt" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.czwt}</textarea>
      </td>
    </tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="xtjj" rows="2" cols="20" id="xtjj" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.xtjj}</textarea>
      </td>
    </tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="gzjh" rows="2" cols="20" id="gzjh" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.gzjh}</textarea>
      </td>
    </tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="jcqk" rows="2" cols="20" id="jcqk" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.jcqk}</textarea>
      </td>
    </tr>
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="zjsm" rows="2" cols="20" id="zjsm" style="font-family:宋体;height:80px;width:95%;" class="txtInput normal required">${zdxmyb.zjsm}</textarea>
      </td>
    </tr>
  </table>
