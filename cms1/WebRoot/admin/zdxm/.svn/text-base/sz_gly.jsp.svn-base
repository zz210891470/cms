...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        ...
        //--------
        function edit(i){
            $("#theFrame").attr("src","<%=basePath%>admin/ManageServlet?action=toEdit&lx=zd&id="+i);
            doShow("frameDiv");
            doHide("listDiv");
        }
        ...
        //添加列表项
        function add(){
            $("#theFrame").attr("src","<%=basePath%>admin/ManageServlet?action=toAdd&lx=zd");
            doShow("frameDiv");
            doHide("listDiv");
        }
		// 显示
        ...
        function hideAddFrame(){
             document.location.href='<%=basePath%>admin/ManageServlet?action=list&lx=zd';
        }
        ...
        function del(i){
            ...
            document.all.pageform.action='<%=basePath%>admin/ManageServlet?action=del&lx=zd'; 
            document.all.pageform.submit(); 
        }
        ...
        function goPage(i){
        	$("#pageNo").val(i);
      	    document.all.pageform.action='<%=basePath%>admin/ManageServlet?action=list&lx=zd';
		    document.all.pageform.submit();    
        }
