		...
		function del(id){
			...
			if(confirm("确定要删除地区名称？")){
         		$.post('<%=basePath%>admin/AreaServlet?act=del&id='+id, function(data){
	          	...
	          	if(data[0]=="SUCCESS"){
	          		location.href="<%=basePath%>admin/AreaServlet?act=list&lx=zd";
	          	}
	    		});
			}
		}
  ...
  <body class="mainbody">
  	<div id="lb">
        <div class="select_box">
            ...
            <span style="float:right;"><a href="#" onclick="location.href='AreaServlet?act=list&lx=zd';" target="_self">刷新</a></span>
        </div>
