...
<script>
    ...
    $(function(){
        $.post("ZdxmServlet?action=getFcymxhzInfo&year=${year}&fromMonth=${fromMonth}&toMonth=${toMonth}",function(data){
	...
	<tr style="height:50px;">
		<td align="right">
			<form name="frm" id="frm" method="post" action="<%=basePath%>admin/AjaxServlet?act=utfxls" target="_blank" style=" margin:0px; padding:0px;">
                <input type="hidden" id="title" name="title" value="龙岩市${year }年重点项目分产业明细汇总"/>
