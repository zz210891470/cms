  ...
  <body class="mainbody">
    ...
    <table width="100%" border="0" align="center" cellspacing="0">
			...
			<p align="center"><b><font color="#336699">龙岩市重点项目月信息报表   
                <span id="ctl00_ContentPlaceHolder1_lbl_year">2014年3月</span></font></b></td>
			</tr>
	  </table>
  <table border="1" width="100%"  align="center" cellspacing="0" bgcolor="#f0f8ff" 
    ...
    <tr>
      <td width="100%" colspan="6">
          <textarea name="jdgz" rows="2" cols="20" id="jdgz" style="font-family:宋体;height:80px;width:100%;"></textarea>
      </td>
    </tr>
    <tr>
      <td width="100%" colspan="6" height="25">
