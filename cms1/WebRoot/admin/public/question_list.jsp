...
<script type="text/javascript" src="../js/function.js"></script>
    ...
    <script type="text/javascript">
        ...
        function update(i){
            $("#theFrame").attr("src","<%=basePath%>admin/public/PeopleQuestionServlet?act=updatepage&id="+i);
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }

        function add(){
            $("#theFrame").attr("src","<%=basePath%>admin/public/PeopleQuestionServlet?act=addpage");
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
        ...
        function hideAddFrame(){
             document.location.href='<%=basePath%>admin/public/PeopleQuestionServlet?act=list';
        }
        ...
        function goPage(i){
        	$("#pageNo").val(i);
      	    document.all.pageform.action='<%=basePath%>admin/public/PeopleQuestionServlet?act=list';
		    document.all.pageform.submit();    
        }
...
<div class="navigation">首页 &gt; 公众参与管理  &gt;  常见问题管理</div>
    <form name="pageform"  method="post">
    <div class="tools_box">
	    <div class="tools_bar">
	        <a href="javascript:add();" class="tools_btn"><span><b class="add">添加问题</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="40%" align="left">问题</th>
   <!--    <th width="20%" align="left">url</th> -->  
        <th width="8%"  align="left">作者</th>
     ...
     <tr>
        ...
        <td>${item.question }</td>
 <!--       <td><a href="Question?url=${item.url }">预览</a></td> --> 
        <td>${item.author }</td>
        <td>${fn:substring(item.time, 0, 10)}</td>
        <td align="center"><a href="javascript:update(${item.id });">修改</a></td>
