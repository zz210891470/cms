...
<title>无标题文档</title>
    ...
    <script type="text/javascript">
        ...
        //--------
        function reply(i){
            $("#theFrame").attr("src","<%=basePath%>admin/public/PeopleMailServlet?act=replypage&id="+i);
        ...
        //浏览
        function look(i){
            $("#theFrame").attr("src","<%=basePath%>admin/public/PeopleMailServlet?act=detail&id="+i);
            $("#frameDiv").removeClass("hideDiv");
            $("#frameDiv").addClass("showDiv");
        }
        ...
        function hideAddFrame(){
             document.location.href='<%=basePath%>admin/public/PeopleMailServlet?act=list';
        }
        ...
        function del(i){
            ...
            document.all.pageform.action='<%=basePath%>admin/public/PeopleMailServlet?act=deleteItems'; 
            document.all.pageform.submit(); 
        }
        ...
        function goPage(i){
        	$("#pageNo").val(i);
      	    document.all.pageform.action='<%=basePath%>admin/public/PeopleMailServlet?act=list';
		    document.all.pageform.submit();    
        }
...
<div class="navigation">首页 &gt; 公众参与管理 &gt; 领导信箱管理</div>
    <div class="tools_box">
	    <div class="tools_bar">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
       <th width="6%">选择</th>
        <th width="15%" align="center">信件编号</th>
        <th align="left">信件标题</th>
