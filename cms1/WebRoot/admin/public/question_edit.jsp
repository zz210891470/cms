...
<body class="mainbody">
<form name="form1" method="post" action="PeopleQuestionServlet?act=update" id="form1">
	<div class="navigation"><a href="javascript:back();" class="back">后退</a>首页 &gt;公众参与管理&gt; 常见问题管理 &gt; 编辑问题</div>
    ...
    <div class="tab_con" style="display:block;">
		...
		<table class="form_table">
				...
				<tr>
					<th>问题</th>
					<td><input name="question" id="bt" type="text" value="${item.question }" maxlength="100"  class="txtInput normal required" />
<span style="color:red;">*</span></td>
				</tr>
				<tr>
					<th>作者</th>
					<td><input name="author" type="text" value="${item.author }" maxlength="100"  class="txtInput normal required" /></td>
				</tr>
		 		<tr>
					<th>发布时间</th>
					<td><input class="Wdate" type="text" onClick="WdatePicker()" value="${item.time }"  id="time" name="time"/> <span style="color:red;">*</span></td>
				</tr> 
				<tr>
                <th valign="top">内容</th>
                <td>
