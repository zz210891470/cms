...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <input id="lblist" value="${lblist }" type="hidden"/>
	<form name="form" method="post" action="<%=basePath%>admin/cbxm/CbxmServlet?action=add" id="form">
    	<div class="navigation"><a href="javascript:back();"  class="back">返回</a>首页 &gt; 储备项目管理 &gt; 项目信息录入</div>
