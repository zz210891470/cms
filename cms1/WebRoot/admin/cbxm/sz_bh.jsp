...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    function singlesave(id){
        ...
        $.post("<%=basePath%>admin/NumberServlet?act=singlesave&lx=cb&id="+id+"&bh="+bhVal+"&sbyh="+sbyhVal,function(data){
           if(data=="ok"){
    ...
    function tofresh(){
        document.all.listform.action="<%=basePath%>admin/NumberServlet?act=search&lx=cb";
    ...
    function save(){
        document.all.listform.action="<%=basePath%>admin/NumberServlet?act=update&lx=cb";
        document.all.listform.submit();
