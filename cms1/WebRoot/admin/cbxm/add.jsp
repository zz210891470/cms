...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <input id="lblist" value="${lblist }" type="hidden"/>
	<form name="form" method="post" action="<%=basePath%>admin/cbxm/CbxmServlet?action=sadd" id="form">
    	<div class="navigation"><a href="<%=basePath%>admin/cbxm/CbxmServlet?action=toImport" target="_self" class="goto">批量导入项目</a>首页 &gt; 储备项目管理 &gt; 项目信息录入</div>
