...
<head>
    ...
    <title>龙岩市重点项目信息管理系统</title>
    <link href="lib/ligerUI/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css" /> 
   <script src="http://ligerui.com/lib/jquery/jquery-1.3.2.min.js" type="text/javascript"></script>  
     
    <script src="http://ligerui.com/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script>
	...
	<script type="text/javascript" src="js/jquery.ztree.core-3.4.min.js"></script>
        ...
        function onClick2(event, treeId, obj, clickFlag) {
            ...
            function logout(){
            	if(confirm("确定要退出【龙岩市重点项目信息管理系统】？")){
...
<style type="text/css"> 
	*{ scrollbar-face-color:#E6F2FD; scrollbar-highlight-color:#ffffff; scrollbar-shadow-color:#D6E4EF; scrollbar-3dlight-color:#F1F9FF; scrollbar-arrow-color:#006699;  scrollbar-track-color:#F1F9FF;  scrollbar-darkshadow-color:#F1F9FF; }
	...
	.logo{height:40px; width:450px; background-image:url(images/sys_logo1.png); margin:5px 0 0 10px; }
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto;  "> 
	<!--左边-->
        <div position="left"  title="管理菜单" id="accordion1"> 
						...
						<c:if test="${fn:contains(qx,'@zsxm')}">
			<div title="招商项目管理" iconcss="menu-icon-order" id="tab7">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			      <li><a class="l-link" href="javascript:f_addTab('zsxm_ll','项目信息录入','zsxm/ZsxmServlet?action=sideradd')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zsxm_gl','项目信息管理','zsxm/ZsxmServlet?action=list')">项目信息管理</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zsxm_tj','项目汇总统计','zsxm/tj.html')">项目汇总统计</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zsxm_sz','项目设置管理','zsxm/sz.html')">项目设置管理</a></li>
				  </ul>
			</div> 
			</c:if>
			<c:if test="${fn:contains(qx,'@cbxm')}">
			<div title="储备项目管理" iconcss="menu-icon-order" id="tab8">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('cbxm_ll','项目信息录入','cbxm/CbxmServlet?action=sideradd')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_sh','项目信息审核','cbxm/CbxmServlet?action=audit')">项目信息审核</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_gl','项目信息管理','cbxm/CbxmServlet?action=list')">项目信息管理</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_tj','项目汇总统计','cbxm/tj.html')">项目汇总统计</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('cbxm_sz','项目设置管理','cbxm/sz.html')">项目设置管理</a></li>
				  </ul>
			</div> 
			</c:if>
			<c:if test="${fn:contains(qx,'@zdxm')}">
			<div title="重点项目管理" iconcss="menu-icon-order" id="tab9">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			  	  <li><a class="l-link" href="javascript:f_addTab('zdxm_ll','重点项目添加','zdxm/ZdxmServlet?action=toAdd&type=2')">重点项目添加</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_sh','重点项目信息审核','zdxm/ZdxmServlet?action=audit')">重点项目信息审核</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_gl','重点项目信息列表','zdxm/ZdxmServlet?action=list')">重点项目信息列表</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_yb','重点项目建设月报','zdxm/ZdxmYbServlet?action=ybgllist')">重点项目建设月报</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_tj','重点项目汇总统计','zdxm/tj.html')">重点项目汇总统计</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdxm_sz','重点项目设置管理','zdxm/sz.html')">重点项目设置管理</a></li>
				  </ul>
			</div> 
			
			</c:if>
			<c:if test="${fn:contains(qx,'@zdaxm')}">
			<div title="重大项目管理" iconcss="menu-icon-order" id="tab10">
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('zdaxm_ll','项目信息录入','zdaxm/ZdaxmServlet?action=sideradd')">项目信息录入</a></li>
				  ...
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_yb','项目月报管理','zdaxm/ZdaxmYbServlet?action=list')">项目月报管理</a></li>
	...
	<div position="bottom" class="footer">
		<div class="copyright">Copyright © 2013-2015 龙岩市创高科技有限公司 All Rights Reserved.</div>
	</div>
    </div>
</body>
</html>
