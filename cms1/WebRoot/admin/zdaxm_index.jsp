...
<style type="text/css"> 
	*{ scrollbar-face-color:#E6F2FD; scrollbar-highlight-color:#ffffff; scrollbar-shadow-color:#D6E4EF; scrollbar-3dlight-color:#F1F9FF; scrollbar-arrow-color:#006699;  scrollbar-track-color:#F1F9FF;  scrollbar-darkshadow-color:#F1F9FF; }
	...
	.logo{height:40px; width:350px; background-image:url(images/sys_logo1.png); margin:5px 0 0 10px; }
	...
	<!--左边-->
        <div position="left"  title="管理菜单" id="accordion1"> 
			...
			<div style=" height:7px;"></div>
				  <ul class="nlist">
			 	  <li><a class="l-link" href="javascript:f_addTab('zdaxm_ll','项目信息录入','zdaxm_sbyh/lr.jsp')">项目信息录入</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_gl','项目信息管理','zdaxm_sbyh/zdaxmServlet?action=list')">项目信息管理</a></li>
				  <li><a class="l-link" href="javascript:f_addTab('zdaxm_yb','项目月报管理','zdaxm_sbyh/zdaxmServlet?action=report')">项目月报管理</a></li>
				  </ul>
			</div> 
        </div>
