...
<body>
    ...
    <div class="mainbody" align="center" style="height:auto;">
    	<div class="infolist_left" style="height:auto;min-height:500px;_height:500px;">
        	<div class="infolist_left_top" style="background-image:url(images/info_xmcb.jpg);"></div>
        ...
        <div class="infolist_right">
       	<div class="address"><span>当前位置：<a href="#" target="_self">网站首页</a> > 项目储备</span></div>
        <div id="main" style="padding-top:20px;">${item }</div>
        </div>
